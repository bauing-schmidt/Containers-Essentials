According to the Wikipedia's article ([link](https://en.wikipedia.org/wiki/Bit_array)), 
...
`BitArray booleans: {true . false . true . true . false . true . true . true . false . false. true . true . false . true}` builds 
